# 🚀 LeetCode Practice – Frequency Counting (Deep Mode)
...
### ✅ Optimized Approach (Index Mapping with HashMap)
...
> **"I use a hashmap to store visited elements so I can find the complement in constant time. For each number, I check if `target - num` exists in the map. This reduces time complexity from O(n²) to O(n)."**
...
### ✅ Optimized Approach 1 (Frequency Map)
...
### ✅ Optimized Approach 2 (Boyer-Moore Voting Algorithm – Advanced)
...
### ✅ Optimized Approach (Frequency Map + Bucket Sort)
...
## 🧠 Key Takeaways – Frequency Counting

✅ **Use hashmaps to replace nested loops**  
✅ **Always explain brute force first**  
✅ **Optimize using frequency maps or sets**  
✅ **Speak while coding in interviews**  
...
👉 **Seen / Visited Set – 5 LeetCode Problems**
...
**We'll continue building this interview-ready DSA repository 💪🚀**
